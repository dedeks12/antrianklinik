            ...
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="{{ route('antrian.create') }}" class="btn rounded-pill btn-primary">Tambah Antrian</a>
                        ...
                        @endif
                        <form action="{{ url('home/antrian') }}" class="mt-4" method="GET">
                                    ...
                                    <tr>
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <!--FORM UPDATE BARANG-->
                                                                <form action="{{ route('status.antrian', $post->id) }}" method="post">
                                                                    @csrf
                                                                    @method('put')
                                        ...
                                        <td>
                                            <form onsubmit="return confirm('Apakah Anda Yakin ?');"
                                                action="{{ route('antrian.destroy', $post->id) }}" method="POST">
                                                <a href="{{ route('antrian.edit', $post->id) }}"
                                                ...
                                                <a class="btn btn-sm btn-warning" title="PREVIEW"
                                                    href="{{ route('antrian.show', $post->id) }}"><i
