        ...
        <div class="content-wrapper">
            <div class="row">
                <div class="col-md-12">
                        ...
                        <div class="tab-pane fade show active" id="business-1" role="tabpanel" aria-labelledby="business-tab">
                            <div class="row">
                                <div class="col-xl-3 col-lg-6 col-sm-6 grid-margin stretch-card">
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="mb-2 text-dark text-center font-weight-normal">Total Antrian Semua
                                                Poli</h4>
                                ...
                                <div class="col-xl-3 col-lg-6 col-sm-6 grid-margin stretch-card">
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="mb-2 text-dark text-center font-weight-normal">Total Antrian Hari Ini
                                            </h4>
                                            <h2 class="mb-4 text-dark text-center font-weight-bold">{{ $antrian_today }}
                                            </h2>
                                            <p class="mt-4 mb-0">Data Antrian Cancel</p>
                                ...
                                <div class="col-xl-3  col-lg-6 col-sm-6 grid-margin stretch-card">
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="mb-2 text-dark text-center font-weight-normal">Total Antrian Poli
                                                Gigi</h4>
                                ...
                                <div class="col-xl-3 col-lg-6 col-sm-6 grid-margin stretch-card">
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="mb-2 text-dark text-center font-weight-normal">Total Antrian Poli
                                                Umum</h4>
                                            <h2 class="mb-4 text-dark text-center font-weight-bold">{{ $antrian_umum }}
                                            </h2>
                                            <p class="mt-4 mb-0">Data Antrian Cancel</p>
                    ...
                    @foreach ($ketersediaanTanggal as $data)
                        <p>Tanggal: {{ $data['tanggal'] }}</p>
                        <p>Ketersediaan: {{ $data['tersedia'] ? 'Tersedia' : 'Penuh' }}</p>
                        <hr>
                    @endforeach
