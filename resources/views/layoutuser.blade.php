    ...
    <div class="container-scroller">
      ...
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
          <a class="navbar-brand brand-logo" href="index.html"><img src="{!! asset('assets/images/favicon-no-bg.png') !!}" alt="logo" /></a>
          <a class="navbar-brand brand-logo-mini" href="index.html"><img src="{!! asset('assets/images/favicon-logo.png') !!}" alt="logo" /></a>
        </div>
            ...
            <li class="nav-item nav-profile dropdown">
              ...
              <div class="dropdown-menu navbar-dropdown dropdown-menu-right p-0 border-0 font-size-sm" aria-labelledby="profileDropdown" data-x-placement="bottom-end">
                ...
                <div class="p-2">
                  ...
                  <a class="dropdown-item py-1 d-flex align-items-center justify-content-between" href="{{route('signout')}}">
                    <span>Log Out</span>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="{{ url('home/hari-ini') }}">Antrian Hari Ini</a></li>
                  <li class="nav-item"> <a class="nav-link" href="{{ url('home/antrian') }}">Seluruh Data Antrian</a></li>
                  {{-- <li class="nav-item"> <a class="nav-link" href="{{ url('home/noantrian') }}">Typography</a></li> --}}
                </ul>
              </div>
            </li>
            {{-- <li class="nav-item">
              <a class="nav-link" href="{{ url('home/antrian')}}">
