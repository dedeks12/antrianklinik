    ...
    <div class="main-panel">
        <div class="content-wrapper">
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Data Antrian Admin</h4>
                        ...
                        @if ($errors->any())
                            ...
                            @endforeach
                        @endif
                        <form action="{{ route('noantrian.update', $antrian->id) }}" class="pt-3" method="POST">
                            @csrf
                            @method('put')
                            ...
                            <div class="mt-3">
                                ...
                                <a class="btn rounded-pill btn-warning" href="{{ url('home/noantrian') }}">Kembali</a>
                            </div>
                        </form>
                    </div>
                </div>
